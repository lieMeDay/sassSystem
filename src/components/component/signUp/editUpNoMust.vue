<template>
  <!-- 报名非必填项 -->
  <div class="NoMust">
    <!-- <div class="refundWrap" v-if="!$newActive">
      <div>
        <b class="b">是否支持退款:</b>
    ...
    <formSet ref="formC" @getFromData="getFromData" :power="noMust.power"></formSet>
    <!-- <div class="jp">
      ...
      <el-upload
        ...
        action="http://report.lvtutech.com/game/match/uploadImg"
...
export default {
  ...
  watch: {
    noMust(val) {
      ...
      this.refundRules = val.refundRules;
      // this.shopLinks = val.shopLinks;
  ...
  methods: {
    ...
    putMsg() {
      ...
      var noMustMsg = {
        ...
        ifRefund: "", //是否退款
        refundRules: this.refundRules, //退款规则
        // shopLinks: this.shopLinks,
        // shopImg: this.shopImg,
        // shopName: this.shopName,
      };
      //   console.log(noMustMsg)
      if (this.radio == 2) {
